...
const brandingData = require("./src/branding/docs.json");
...
function app(clean) {
  return Metalsmith(__dirname)
    ...
    .use(
      redirect({
        redirections: {
          "/docs/truffle/getting-started/working-with-quorum":
            "/docs/truffle/distributed-ledger-support/working-with-quorum",
          "/docs/truffle/getting-started/working-with-hyperledger-evm":
            "/docs/truffle/distributed-ledger-support/working-with-hyperledger-evm",
        },
      })
    );
}
