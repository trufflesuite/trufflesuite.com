...
exports.AssignProjectName = exports.AddProject = exports.ListResources = exports.LookupNames = exports.GetProject = void 0;
...
`;
exports.ListResources = graphql_tag_1.default `
  query ListResources(
    $projectId: ID!
  ) {
    project(id: $projectId) {
