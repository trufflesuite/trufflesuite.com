...
If you run into issues with the beta version, don't hesitate to [write up an issue](https://github.com/trufflesuite/truffle/issues) in our issue tracker or reach out to fellow Trufflers for help from the community on [Gitter](https://gitter.im/ConsenSys/truffle). We're happy to help.
