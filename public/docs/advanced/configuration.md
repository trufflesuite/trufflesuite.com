...
By default, Truffle looks for keys during testing in ./test/truffle-keys.js. The format of this file is seen here:
https://github.com/ajb413/erc20-ethereum-token/blob/master/test/truffle-keys.js
