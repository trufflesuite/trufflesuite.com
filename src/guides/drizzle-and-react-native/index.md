...
1. [Getting started with Drizzle and React](/tutorials/getting-started-with-drizzle-and-react)
...
Do the steps from [Writing our smart contract](/tutorials/getting-started-with-drizzle-and-react#writing-our-smart-contract) up to (and including) [Migration](/tutorials/getting-started-with-drizzle-and-react#migration).
...
This is pretty much the same as [the web tutorial](/tutorials/getting-started-with-drizzle-and-react#wire-up-the-app-component), but with React Native components instead of web ones. Refer to the web tutorial for a more in-depth explanation of what's going on.
...
Once again, this is very similar to the [web tutorial](/tutorials/getting-started-with-drizzle-and-react#write-a-component-to-read-from-drizzle), just with React Native components.
...
Once again, this is very similar to the [web tutorial](/tutorials/getting-started-with-drizzle-and-react#write-a-component-to-write-to-the-smart-contract), just with React Native components.
