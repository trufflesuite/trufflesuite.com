---
title: Truffle Teams | Truffle Teams Quickstart
layout: docs.hbs
---
...
![Truffle Teams DATA view](/img/docs/truffle-teams/install-01.png)
...
<p class="alert alert-info">
<strong>Note</strong>: We can always add a repo later if necessary. See the [Adding Repositories](/docs/truffle-teams/getting-started/adding-repositories) documentation for more informaiton.
</p>

Finally, click the `Install` button to install Truffle Teams on the selected repos and be redirected to the `BUILDS` page.

<p class="alert alert-warning">
<strong>Why do we need certain permissions?</strong>: Please see the [Permissions Disclosure](/docs/truffle-teams/reference/permissions-disclosure) section for a full breakdown of why we're asking for each permission.
</p>

![Truffle Teams DATA view](/img/docs/truffle-teams/install-02.png)
...
This quickstart showed you the basics of the Truffle Teams testing workflow, but once your contracts are deployed there's more to learn about **[monitoring deployed contracts](/docs/truffle-teams/contracts/monitoring-contracts)**.
