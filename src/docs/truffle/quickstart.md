...
<p class="alert alert-info">
<strong>Note</strong>: We're using `web3.eth.getAccounts()` in these examples, which returns an array of all the accounts generated by the mnemonic. So, given the addresses generated by our mnemonic above, specifying `web3.eth.getAccounts().then(accounts => accounts[0])` is equivalent to the address `0x627306090abab3a6e1400e9345bc60c78a8bef57`.
</p>
